...
\begin{align*}
    \mathrm{NO_2} &: 38.4 \pm 23.2 \\
    \mathrm{O_3} &: 37.0 \pm 22.0 
\end{align*}
\todo{units?}
...
The minimum of the NO$_2$ concentration is for example at $-3$ \todo{units}. 
...
In this case the value of $-3$ \todo{unit} could be understood as an error code. 
